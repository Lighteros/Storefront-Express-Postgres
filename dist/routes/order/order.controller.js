...
var createOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, status, products, canSave, order, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                status = false;
                canSave = [userId, products].every(Boolean);
                console.log(userId, products);
                if (!canSave) {
                    return [2 /*return*/, next(new globalErrorHandler_1.BadRequest('All fields are required'))];
                }
                if (!products.length) {
                    return [2 /*return*/, next(new globalErrorHandler_1.BadRequest('No products added'))];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, orderModel.create({ products: products, userId: userId, status: status })];
            case 2:
                order = _a.sent();
...
var deleteOrder = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, orderModel["delete"](orderId)];
            case 2:
                order = _a.sent();
